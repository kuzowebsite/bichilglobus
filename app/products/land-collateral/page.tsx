...
import { Map, Zap, Percent, BadgeCheck, FileText, LucideIcon, LandPlot } from 'lucide-react';

export default function LandCollateralPage() {
  return (
      ...
      <section className="fixed inset-0 w-full h-full z-0">
         ...
         <div className="absolute bottom-32 left-0 w-full px-4 sm:px-6 lg:px-8 z-10 text-center max-w-5xl mx-auto">
            <h1 className="text-4xl md:text-7xl font-extrabold text-white mb-6 leading-tight drop-shadow-lg">
              Ирээдүйн үнэ цэнээ <br /> <span className="text-teal-400">Өнөөдөр ашигла</span>
            </h1>
            <p className="text-gray-200 text-lg md:text-xl font-light mb-8 max-w-2xl mx-auto">
              Өмчлөх эрхтэй газар барьцаалсан шуурхай зээл.
            </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
            ...
            <div className="lg:col-span-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
                 <FeatureCard 
                    icon={LandPlot} 
                    title="Өмчлөх эрхтэй" 
                    desc="Өмчлөх эрхийн гэрчилгээтэй бүх төрлийн газрыг барьцаална." 
                 />
                 <FeatureCard 
                    icon={Map} 
                    title="Байршил харгалзахгүй" 
                    desc="Улаанбаатар хотын аль ч бүсэд байрлалтай газрыг зах зээлийн үнээр үнэлнэ." 
                 />
                 <FeatureCard 
                    icon={Zap} 
                    title="Шуурхай" 
                    desc="Газрын кадастрын мэдээлэлд үндэслэн хурдан хугацаанд шийдвэрлэнэ." 
                 />
              </div>
              ...
              <div className="mb-12">
                 ...
                 <div className="relative border-l-2 border-teal-500/30 ml-3 space-y-8">
                    <StepItem number="01" title="Хүсэлт" desc="Газрын гэрчилгээ, кадастрын зургаа авч ирэн хүсэлт өгнө." />
                    <StepItem number="02" title="Үнэлгээ" desc="Газрын байршил, зориулалт, ирээдүйн үнэ цэнийг харгалзан үнэлнэ." />
                    <StepItem number="03" title="Гэрээ" desc="Барьцааны гэрээ байгуулж, улсын бүртгэлд бүртгүүлнэ." />
                    <StepItem number="04" title="Олголт" desc="Зээлийн дүнг таны дансанд шилжүүлнэ." />
                 </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                 <div className="bg-white/60 p-6 rounded-3xl border border-white/60">
                    ...
                    <ul className="space-y-3 text-sm text-gray-700">
                       <li className="flex justify-between border-b border-gray-200 pb-2">
                          <span>Зээлийн дүн:</span> <span className="font-bold">200.0 сая ₮ хүртэл</span>
                       </li>
                       <li className="flex justify-between border-b border-gray-200 pb-2">
                 ...
                 <div className="bg-white/60 p-6 rounded-3xl border border-white/60">
                    ...
                    <ul className="list-disc list-inside space-y-2 text-sm text-gray-700 marker:text-teal-500">
                       ...
                       <li>Газрын гэрчилгээ (эх хувиар)</li>
                       <li>Кадастрын зураг</li>
                       <li>Газрын төлбөр төлсөн баримт</li>
                    </ul>
                 </div>
              </div>
            ...
            <div className="lg:col-span-4">
               <div className="sticky top-24 space-y-6">
                  <LoanCalculator defaultRate={3.0} />
               </div>
            </div>
