...
import { TrendingUp, Briefcase, Percent, BadgeCheck, PieChart, Users, LucideIcon } from 'lucide-react';
      ...
      <section className="fixed inset-0 w-full h-full z-0">
         ...
         <div className="absolute bottom-32 left-0 w-full px-4 sm:px-6 lg:px-8 z-10 text-center max-w-5xl mx-auto">
            <h1 className="text-4xl md:text-7xl font-extrabold text-white mb-6 leading-tight drop-shadow-lg">
              Бизнесээ өргөжүүлэх <br /> <span className="text-teal-400">санхүүгийн түнш</span>
            </h1>
            <p className="text-gray-200 text-lg md:text-xl font-light mb-8 max-w-2xl mx-auto">
              Эргэлтийн хөрөнгө болон хөрөнгө оруулалтын зориулалттай бизнес зээл.
            </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
            ...
            <div className="lg:col-span-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
                 <FeatureCard 
                    ...
                    desc="Бизнесийн үйл ажиллагааг тасралтгүй явуулахад шаардлагатай санхүүжилт." 
                 />
                 <FeatureCard 
                    icon={Briefcase} 
                    title="Хөрөнгө оруулалт" 
                    desc="Тоног төхөөрөмж худалдан авах, ажлын байраа өргөтгөхөд зориулагдсан." 
                 />
                 <FeatureCard 
                    icon={Percent} 
                    title="Уян хатан нөхцөл" 
                    desc="Таны бизнесийн онцлогт тохирсон эргэн төлөлтийн хуваарь." 
                 />
              </div>
              ...
              <div className="mb-12">
                 ...
                 <div className="relative border-l-2 border-teal-500/30 ml-3 space-y-8">
                    <StepItem number="01" title="Хүсэлт гаргах" desc="Санхүүгийн тайлан болон бусад материалаа бүрдүүлэн хүсэлт өгнө." />
                    <StepItem number="02" title="Бизнесийн судалгаа" desc="Зээлийн мэргэжилтэн таны бизнесийн үйл ажиллагаатай танилцана." />
                    <StepItem number="03" title="Шийдвэр гаргах" desc="Зээлийн хорооны хурлаар таны хүсэлтийг хэлэлцэн шийдвэрлэнэ." />
                    <StepItem number="04" title="Санхүүжилт авах" desc="Гэрээ байгуулж, санхүүжилтээ хүлээн авна." />
                 </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                 <div className="bg-white/60 p-6 rounded-3xl border border-white/60">
                    ...
                    <ul className="space-y-3 text-sm text-gray-700">
                       <li className="flex justify-between border-b border-gray-200 pb-2">
                          <span>Зээлийн дүн:</span> <span className="font-bold">500.0 сая ₮ хүртэл</span>
                       </li>
                       <li className="flex justify-between border-b border-gray-200 pb-2">
                          <span>Хүү (сарын):</span> <span className="font-bold">2.0% - 3.0%</span>
                       </li>
                       <li className="flex justify-between border-b border-gray-200 pb-2">
                          <span>Хугацаа:</span> <span className="font-bold">60 сар хүртэл</span>
                       </li>
                       <li className="flex justify-between border-b border-gray-200 pb-2">
                          <span>Барьцаа:</span> <span className="font-bold">Үл хөдлөх, Хөдлөх</span>
                       </li>
                    </ul>
                 </div>
                 ...
                 <div className="bg-white/60 p-6 rounded-3xl border border-white/60">
                    ...
                    <ul className="list-disc list-inside space-y-2 text-sm text-gray-700 marker:text-teal-500">
                       <li>Компанийн улсын бүртгэлийн гэрчилгээ</li>
                       <li>Компанийн дүрэм</li>
                       <li>Сүүлийн 1-2 жилийн санхүүгийн тайлан</li>
                       <li>Тусгай зөвшөөрөл (шаардлагатай бол)</li>
                       <li>Барьцаа хөрөнгийн бичиг баримт</li>
                    </ul>
                 </div>
              </div>
            ...
            <div className="lg:col-span-4">
               <div className="sticky top-24 space-y-6">
                  <LoanCalculator defaultRate={2.5} />
                  
                  <div className="bg-[#0B1221] text-white p-6 rounded-3xl shadow-xl relative overflow-hidden">
                      <div className="relative z-10">
                          <h4 className="font-bold text-lg mb-2">Хамтран ажиллах</h4>
                          <p className="text-gray-400 text-sm mb-4">
                              Бид таны бизнесийг дэмжиж, урт хугацаанд хамтран ажиллахдаа таатай байх болно.
                          </p>
                          <button className="w-full py-3 bg-teal-600 hover:bg-teal-500 rounded-xl font-bold text-sm transition-colors">
                              Зөвлөгөө авах
                          </button>
                      </div>
