...
import { ShieldCheck, Zap, Clock, FileText, CheckCircle2, BadgeCheck, LucideIcon } from 'lucide-react';

export default function CarCollateralPage() {
  return (
      ...
      <section className="fixed inset-0 w-full h-full z-0">
         ...
         <div className="absolute bottom-32 left-0 w-full px-4 sm:px-6 lg:px-8 z-10 text-center max-w-4xl mx-auto">
            <h1 className="text-4xl md:text-7xl font-extrabold text-white mb-6 leading-tight drop-shadow-lg">
              Автомашин барьцаалсан <br /> <span className="text-teal-400">шуурхай зээл</span>
            </h1>
            <p className="text-gray-200 text-lg md:text-xl font-light mb-8">
              Та машинаа унаад явах боломжтой. Зах зээлийн үнэлгээний 80% хүртэлх санхүүжилт.
            </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
            ...
            <div className="lg:col-span-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
                 <FeatureCard 
                    icon={Zap} 
                    title="Шуурхай" 
                    desc="1-2 цагийн дотор зээлээ шийдүүлэн аваарай." 
                 />
                 <FeatureCard 
                    icon={ShieldCheck} 
                    title="Найдвартай" 
                    desc="Таны машиныг найдвартай, дулаан гаражид хадгална." 
                 />
                 <FeatureCard 
                    icon={Clock} 
                    title="Уян хатан" 
                    desc="60 хүртэлх сарын хугацаатай, уян хатан нөхцөл." 
                 />
              </div>
              ...
              <div className="mb-12">
                 ...
                 <div className="relative border-l-2 border-teal-500/30 ml-3 space-y-8">
                    <StepItem number="01" title="Хүсэлт илгээх" desc="Онлайнаар эсвэл салбар дээр ирж хүсэлтээ өгнө." />
                    <StepItem number="02" title="Үнэлгээ хийх" desc="Манай мэргэжилтэн таны машиныг үнэлнэ." />
                    <StepItem number="03" title="Гэрээ байгуулах" desc="Зээлийн гэрээ болон барьцааны гэрээ байгуулна." />
                    <StepItem number="04" title="Мөнгөө авах" desc="Зээлийн дүнг таны данс руу шилжүүлнэ." />
                 </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                 ...
                 <div className="bg-white/60 p-6 rounded-3xl border border-white/60">
                    ...
                    <ul className="list-disc list-inside space-y-2 text-sm text-gray-700 marker:text-teal-500">
                       ...
                       <li>Тээврийн хэрэгслийн гэрчилгээ</li>
                       <li>Орлого нотлох баримт (шаардлагатай бол)</li>
                       <li>Тээврийн хэрэгслийн даатгал</li>
                    </ul>
                 </div>
              </div>
            ...
            <div className="lg:col-span-4">
               <div className="sticky top-24 space-y-6">
                  {/* Default Rate for Collateral loan usually higher than purchase */}
