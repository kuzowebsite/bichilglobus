...
import { Building, TrendingUp, BadgeCheck, LucideIcon, Key } from 'lucide-react';

export default function ApartmentCollateralPage() {
  return (
      ...
      <section className="fixed inset-0 w-full h-full z-0">
         ...
         <div className="absolute bottom-32 left-0 w-full px-4 sm:px-6 lg:px-8 z-10 text-center max-w-5xl mx-auto">
            <h1 className="text-4xl md:text-7xl font-extrabold text-white mb-6 leading-tight drop-shadow-lg">
              Орон сууцаа барьцаалан <br /> <span className="text-teal-400">Таатай нөхцөлөөр</span>
            </h1>
            <p className="text-gray-200 text-lg md:text-xl font-light mb-8 max-w-2xl mx-auto">
              Зах зээлийн дээд үнэлгээ, урт хугацаа, бага хүүтэй орон сууцны барьцаат зээл.
            </p>
            ...
            <div className="lg:col-span-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
                 <FeatureCard 
                    icon={TrendingUp} 
                    title="Дээд үнэлгээ" 
                    desc="Таны байрыг зах зээлийн бодит үнээр үнэлж, өндөр дүнгээр зээл олгоно." 
                 />
                 <FeatureCard 
                    icon={Key} 
                    title="Чөлөөлөх" 
                    desc="Банк болон ББСБ-ын зээлийг чөлөөлж, нэмэлт санхүүжилт авах боломжтой." 
                 />
                 <FeatureCard 
                    icon={Building} 
                    title="Шуурхай" 
                    desc="Олон шат дамжлагагүй, 1 өдрийн дотор шийдвэрлэж дансанд шилжүүлнэ." 
                 />
              </div>
              ...
              <div className="mb-12">
                 ...
                 <div className="relative border-l-2 border-teal-500/30 ml-3 space-y-8">
                    <StepItem number="01" title="Хүсэлт" desc="Орон сууцны гэрчилгээтэйгээ ирж зээлийн судалгаа хийлгэнэ." />
                    <StepItem number="02" title="Үнэлгээ" desc="Орон сууцны байршил, чанар, зах зээлийн үнийг тогтооно." />
                    <StepItem number="03" title="Гэрээ" desc="Барьцааны гэрээ байгуулж, УБЕГ-т бүртгүүлнэ." />
                    <StepItem number="04" title="Олголт" desc="Гэрээ баталгаажсаны дараа мөнгө шилжүүлнэ." />
                 </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                 <div className="bg-white/60 p-6 rounded-3xl border border-white/60">
                    ...
                    <ul className="space-y-3 text-sm text-gray-700">
                       ...
                       <li className="flex justify-between border-b border-gray-200 pb-2">
                          <span>Шимтгэл:</span> <span className="font-bold">0.5% - 1%</span>
                       </li>
                    </ul>
                 </div>
                 ...
                 <div className="bg-white/60 p-6 rounded-3xl border border-white/60">
                    ...
                    <ul className="list-disc list-inside space-y-2 text-sm text-gray-700 marker:text-teal-500">
                       <li>Иргэний үнэмлэх (Бүх өмчлөгчид)</li>
                       <li>Үл хөдлөх хөрөнгийн гэрчилгээ (эх хувиар)</li>
                       <li>Оршин суугаа хаягийн лавлагаа</li>
               ...
               <div className="sticky top-24 space-y-6">
                  ...
                  <div className="bg-[#0B1221] text-white p-6 rounded-3xl shadow-xl relative overflow-hidden">
                      <div className="relative z-10">
                          <h4 className="font-bold text-lg mb-2">Зээл чөлөөлнө</h4>
                          <p className="text-gray-400 text-sm mb-4">
                              Та өөр банк эсвэл ББСБ-д зээлтэй бол бид зээлийг тань чөлөөлж, нэмэгдүүлэн олгох боломжтой.
                          </p>
